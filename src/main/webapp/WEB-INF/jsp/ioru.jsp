...
<table  border="1">
    ...
    <tr>
        ...
        <td>${m.deptno}</td>
        <td>
            <a href="<%=path%>/deleteemp.do?empno=${m.empno}">删除</a>
            <a href="<%=path%>/findById.do?empno=${m.empno}">修改</a>
        </td>
    </tr>
    </c:forEach>
    <a href="<%=path%>/findById.do">添加</a>
...
var totalRecord;
    ...
    function build_emps_table(result) {
            ...
            $.each(emps, function (index, item) {
                ...
                var deptno = $("<td></td>").append(item.deptno);
                ...
                var delBtn = $("<botton></boatton>").addClass("btn btn-danger btn-sm delete_btn")
